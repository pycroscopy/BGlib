...
from BGlib import __version__ as sr_version
...
latex_documents = [
    (master_doc, 'BGlib.tex', 'BGlib Documentation',
     'Suhas Somnath, Chris R. Smith, Rama K. Vasudevan, Stephen Jesse, Anton '
     'Ievlev, and contributors',
     'manual'),
]
...
man_pages = [
    (master_doc, 'BGlib', 'BGlib Documentation',
     [author], 1)
]
