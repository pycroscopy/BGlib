...
from pyUSID.io.hdf_utils import create_indexed_group, write_ind_val_dsets, write_main_dataset
...
class GTuneTranslator(GLineTranslator):
    ...
    def translate(self, file_path):
        ...
        (basename, parm_paths, data_paths) = super(GTuneTranslator, self)._parse_file_path(
            file_path
        )
